...
public:
    ...
    void printQueue() {
        ...
        cout << "------------------------------------------------------------------------------------------------------------\n";
        cout << setw(9) << right << "ID" << setw(25) << "Product Name" << setw(18) << "Category" << setw(17) << "Size" << setw(18) << "Color" << setw(19) << "Price" << endl;
        cout << "------------------------------------------------------------------------------------------------------------\n";
        
        Product* current = front;
        while (current != nullptr) {
            cout << setw(9) << right << current->key << setw(25) << current->name << setw(18) << current->category << setw(16) << current->size << setw(19) << current->color << setw(16) << "RM " << fixed << setprecision(2) << current->price << endl;
            current = current->next;
        }
        cout << "------------------------------------------------------------------------------------------------------------\n";
    }
    ...
    void display() {
        ...
        for (int i = topstack; i >= 0; --i) {
            ...
            cout << "| " << left
              ...
              << setw(6) << p.size << " | "
              << setw(12) << p.color << " | "
              << "RM "<<setw(7) << fixed << setprecision(2) << p.price << " |\n";
        }
        ...
        case 3: {
        	if (!st.empty()) {
				...
				cout << "Removed Product\n"
				     ...
				     << "Size        : " << p.size << "\n"
				     << "Color       : " << p.color << "\n"
				     << "Price       : RM" << fixed << setprecision(2) << p.price << "\n\n";
	    	}
